...
// still happens on the LinkedIn page itself.
export function RecentJobsWidget({ linkedinJobs }: RecentJobsWidgetProps) {
  const jobs = [...linkedinJobs].sort((a, b) => b.created_at.localeCompare(a.created_at));
